...
export const DEFAULT_CONFIG: AppConfig = {
  ...
  bunkAdjustmentMode: 'percent',
  bunkScoreAdjustments: [
    { score: BunkScore.Zero, adjustmentPercentage: 10, adjustmentKgMS: 0.2 },
    { score: BunkScore.Half, adjustmentPercentage: 5, adjustmentKgMS: 0.1 },
    { score: BunkScore.One, adjustmentPercentage: 0, adjustmentKgMS: 0 },
    { score: BunkScore.OneHalf, adjustmentPercentage: -2.5, adjustmentKgMS: -0.1 },
    { score: BunkScore.Two, adjustmentPercentage: -5, adjustmentKgMS: -0.3 },
    { score: BunkScore.Three, adjustmentPercentage: -10, adjustmentKgMS: -0.5 },
    { score: BunkScore.Four, adjustmentPercentage: -15, adjustmentKgMS: -1.0 },
  ],
  loadingLimitLower: -5,
  loadingLimitUpper: 5,
  gmdCurves: [
